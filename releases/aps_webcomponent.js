(function () {
    ...
    tmpl.innerHTML = `
        ...
        lsc-datepicker-aps > p {
            margin: 16px 0 4px 0;
            line-height: 22px;
            font-size: 0.875rem;
            color: #999999;
        }
        lsc-datepicker-aps > p:first-of-type {
            margin-top: 0;
        }
        lsc-datepicker-aps > label {
            color: #333333 !important;
            font-size: 0.875rem;
        }
        lsc-datepicker-aps select {
            border: 1px solid rgb(191, 191, 191);
            padding: 3px 5px;
            width: calc(100% + 20px);
        }
        lsc-datepicker-aps select:hover,
        lsc-datepicker-aps select:focus {
            border: 1px solid #346187;
            cursor: pointer;
        }
        lsc-datepicker-aps > div.select {
            position: relative;
            overflow: hidden;
        }
        lsc-datepicker-aps > div.select::after {
            content: "\ue7ac";
        ...
        lsc-datepicker-aps > div.select:focus-within::after,
        lsc-datepicker-aps > div.select:hover::after {
            background-color: rgba(179, 179, 179, 0.5);
            border: 1px solid #346187;
            border-left-color: transparent;
        }
        lsc-datepicker-aps .checkbox {
            position: relative;
            display: flex;
            align-items: center;
            height: 22px;
        }
        lsc-datepicker-aps .checkbox input {
            position: absolute;
            opacity: 0;
            cursor: pointer;
            height: 0;
        ...
        lsc-datepicker-aps .checkbox div.checkmark {
            position: relative;
            height: 16px;
            width: 16px;
        ...
        lsc-datepicker-aps .checkbox div.checkmark:hover {
            cursor: pointer;
            border-color: #427cac;
        }
        lsc-datepicker-aps .checkbox input:checked ~ div.checkmark:after {
            content: "\ue614";
            font-family: "fpa-icons";
            color: #427cac;
            position: absolute;
        ...
        lsc-datepicker-aps .checkbox input:focus ~ div.checkmark {
            outline: 1px dotted #333;
        }
        lsc-datepicker-aps p.info {
    ...
    customElements.define('lsc-datepicker-aps', DatePickerAps);
})();